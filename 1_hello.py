...
st.markdown(
        ...
        **👈 Select a demo from the sidebar** to see some examples of what Streamlit can do!
        ...
        - Jump into our [documentation](https://docs.strea,lit.io)
        - Ask a question in our [comnnunity forums](https://discuss.streamlit.io)
        ### See more complex demos
        - Use a neural net to [analyze the Udacity Self-driving Car Image Dataset](https://github.com/streamlit/demo-self-driving)
        -Explore a [New York City rideshare dataset](https://github.com/streamlit/demp-uber-nyc-pickups)
        """
        )
